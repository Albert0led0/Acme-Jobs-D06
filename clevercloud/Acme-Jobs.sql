...
CREATE TABLE `duty` (
  ...
  `version` int(11) NOT NULL,
  `description` varchar(255) DEFAULT NULL,
  `time_percentage` double NOT NULL,
  `title` varchar(255) DEFAULT NULL,
  `job_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `paton_bulletin`
--
...
--
-- Dumping data for table `paton_bulletin`
--

LOCK TABLES `paton_bulletin` WRITE;
/*!40000 ALTER TABLE `paton_bulletin` DISABLE KEYS */;
/*!40000 ALTER TABLE `paton_bulletin` ENABLE KEYS */;
UNLOCK TABLES;
